...
const SYSTEM = [
  ...
  "Start with read_scene_readiness, which is registered even before the scene opens and says what this browser supports. Once the scene is open, call read_scene_summary before your first change; it gives the frame count, each actor and its origin and spans, the camera cuts, and the version.",
